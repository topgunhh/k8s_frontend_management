<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogPodNumPvVisible" title="statistics">
      <el-table :data="podNumData" border fit highlight-current-row style="width: 100%">
        <el-table-column prop="key" label="Channel" />
        <el-table-column prop="pv" label="Pv" />
      </el-table>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="dialogPodNumPvVisible = false">Confirm</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle, fetchPodNum } from '@/api/k8s_resource'
...
export default {
  ...
  methods: {
    ...
    handlePodNumFetchPv(podNum) {
      fetchPodNum(podNum).then(response => {
        this.podNumData = response.data.podNumData
        this.dialogPodNumPvVisible = true
      })
    },
    handleFetchPv(pv) {
